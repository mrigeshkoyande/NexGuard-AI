  ...
  return (
    ...
    >
      ...
      <div className="border-b border-green-900/50 pb-3">
        <h2 className="text-base font-black text-green-400 flex items-center gap-2 tracking-tighter">
          <Zap size={18} />
          CONTROL PANEL
        </h2>
        <p className="text-[10px] text-green-800 mt-1 font-mono">
          STATUS: {systemStatus.shieldActive ? "PROTECTED" : "NORMAL"}
          {systemStatus.lockdown && " / LOCKDOWN"}
        </p>
      </div>
      ...
      <div className="border-t border-green-900 pt-4 space-y-2">
        ...
        <div className="space-y-2 text-xs">
          <div className="flex items-center justify-between p-2 bg-black/30 rounded">
            ...
            <span
              className={`px-2 py-1 rounded ${systemStatus.shieldActive
          ...
          <div className="flex items-center justify-between p-2 bg-black/30 rounded">
            ...
            <span
              className={`px-2 py-1 rounded ${systemStatus.lockdown
